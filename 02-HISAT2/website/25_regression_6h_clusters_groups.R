...
clusters.de <- scde.clusters[["6h_cluster2-cluster1"]]
head(clusters.de, n=2)

groups.de.d23 <- scde.groups[["6h_STM-D23580_Violet +-6h_STM-D23580_Exposed"]]
head(groups.de.d23, n=2)

groups.de.lt2 <- scde.groups[["6h_STM-LT2_Violet +-6h_STM-LT2_Exposed"]]
...
ggsave("25_out/regression_6h_clusters_groups.pdf", height = 4, width = 5.5)
