...
First let us define shared components of the figures to limit redundancy:
...
ggplot(multiqc, aes(Sample, featureCounts_Assigned)) +
  ...
  geom_hline(yintercept = 10^(multiqc.assigned.M)) + legendBottomTheme
```
...
ggplot(multiqc, aes(Sample, FastQC_percent_gc)) +
  ...
  geom_hline(yintercept = multiqc.GC.M) + legendBottomTheme
```
...
ggplot(multiqc, aes(Sample, Bowtie.2_overall_alignment_rate)) +
  ...
  ylab("HISAT.2_overall_alignment_rate") + legendBottomTheme
```
...
ggplot(pData(sce.all), aes(Sample, pct_counts_top_50_features)) +
  ...
  geom_hline(yintercept = scater.top50.M) + legendBottomTheme
```
...
ggplot(pData(sce.all), aes(Sample, pct_counts_top_100_features)) +
  ...
  geom_hline(
    ...
    colour = "red", linetype = 2:1) +
  geom_hline(yintercept = scater.top100.M) + legendBottomTheme
```
...
ggplot(pData(sce.all), aes(Sample, pct_counts_top_200_features)) +
  ...
  geom_hline(
    ...
    colour = "red", linetype = 2:1) +
  geom_hline(yintercept = scater.top200.M) + legendBottomTheme
```
...
ggplot(pData(sce.all), aes(Sample, total_features)) +
  ...
  geom_hline(yintercept = scater.features.M) + legendBottomTheme
```
...
ggplot(pData(sce.all), aes(Sample, pct_counts_feature_controls_ERCC)) +
  ...
  geom_hline(yintercept = scater.ERCC.M) + legendBottomTheme
```
...
ggplot(pData(sce.all), aes(Sample, pct_counts_feature_controls_MT)) +
  ...
  geom_hline(yintercept = scater.MT.M) + legendBottomTheme
```
