...
# Comparison of fold-change estimates {.tabset}

Let us first define:

* a function that displays as violins the expression level of a given
  gene in each group
...
normExprsByName.4h <- function(geneId){
  ...
  ggplot(gdata, aes(Status, norm_exprs, fill = Status)) + 
    ...
    scale_y_continuous(limits=range(norm_exprs(sce.endo))) + theme_minimal()
}
```
...
```{r 4h_MLE_cluster_group, echo=FALSE}
...
```{r CCL7_normExprsByName.4h, echo=FALSE, message=FALSE}
normExprsByName.4h("ENSG00000108688")
```

### S100A9

```{r S100A9_normExprsByName.4h, echo=FALSE, message=FALSE}
normExprsByName.4h("ENSG00000163220")
```

### CTSL

```{r CTSL_normExprsByName.4h, echo=FALSE, message=FALSE}
normExprsByName.4h("ENSG00000135047")
```

### CTSD

```{r CTSD_normExprsByName.4h, echo=FALSE, message=FALSE}
normExprsByName.4h("ENSG00000117984")
```

### STAT5B

```{r STAT5B_normExprsByName.4h, echo=FALSE, message=FALSE}
normExprsByName.4h("ENSG00000173757")
```

### CCL1

```{r CCL1_normExprsByName.4h, echo=FALSE, message=FALSE}
normExprsByName.4h("ENSG00000108702")
```

### CD40

```{r CD40_normExprsByName.4h, echo=FALSE, message=FALSE}
normExprsByName.4h("ENSG00000101017")
```

### IL1B

```{r IL1B_normExprsByName.4h, echo=FALSE, message=FALSE}
...
```{r 6h_MLE_cluster_group, echo=FALSE}
