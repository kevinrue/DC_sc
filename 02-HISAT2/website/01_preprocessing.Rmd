...
(version `0.4.1`; using *cutadapt* version `1.10`) was tested,
...
The ERCC Fasta and GTF files were obtained from the *ThermoFisher*
...
Raw (*i.e.*, not trimmed) read pairs were aligned as follows:
