...
```{r cleanCounts}
cd <- clean.counts(counts(sce.norm)[!isSpike(sce.norm),])
...
In this case, only ERCC spike-in feature were removed:
...
during earlier [sample QC](03_sample_QC.html)); as a consequence,
