...
normExprsById <- function(geneId){
  ...
  ggplot(gdata, aes(Infection, norm_exprs)) + 
    ...
    ggtitle(sprintf("%s - %s", geneId, geneName)) + theme_minimal()
}
```
...
```{r contrasts.time}
contrasts.2h <- list(
  c("2h_STM-D23580_Violet +", "2h_Mock_Violet +"), # vs. Mock
  c("2h_STM-LT2_Violet +", "2h_Mock_Violet +"),
  c("2h_STM-D23580_Exposed", "2h_Mock_Violet +"),
  c("2h_STM-LT2_Exposed", "2h_Mock_Violet +"),
  c("2h_STM-D23580_Violet +", "2h_STM-LT2_Violet +"), # direct
  c("2h_STM-D23580_Violet +", "2h_STM-D23580_Exposed"),
  c("2h_STM-LT2_Violet +", "2h_STM-LT2_Exposed"),
  c("2h_STM-D23580_Exposed", "2h_STM-LT2_Exposed")
)
contrasts.4h <- list(
  c("4h_STM-D23580_Violet +", "4h_Mock_Violet +"), # 4h
  c("4h_STM-LT2_Violet +", "4h_Mock_Violet +"),
  c("4h_STM-D23580_Exposed", "4h_Mock_Violet +"),
  c("4h_STM-LT2_Exposed", "4h_Mock_Violet +"),
  c("4h_STM-D23580_Violet +", "4h_STM-LT2_Violet +"), # 4h
  c("4h_STM-D23580_Violet +", "4h_STM-D23580_Exposed"),
  c("4h_STM-LT2_Violet +", "4h_STM-LT2_Exposed"),
  c("4h_STM-D23580_Exposed", "4h_STM-LT2_Exposed")
)
contrasts.6h <- list(
  c("6h_STM-D23580_Violet +", "6h_Mock_Violet +"), # 6h
  c("6h_STM-LT2_Violet +", "6h_Mock_Violet +"),
  c("6h_STM-D23580_Exposed", "6h_Mock_Violet +"),
  c("6h_STM-LT2_Exposed", "6h_Mock_Violet +"),
  c("6h_STM-D23580_Violet +", "6h_STM-LT2_Violet +"), # 6h
  c("6h_STM-D23580_Violet +", "6h_STM-D23580_Exposed"),
  c("6h_STM-LT2_Violet +", "6h_STM-LT2_Exposed"),
...
```{r fig1_volcano_4h_D23_InfExp, echo=FALSE, eval=FALSE}
sub.data <- subset(
  v.data,
  Contrast == "STM-D23580 Violet +-STM-D23580 Exposed" & Time == "4h"
)
geneData <- subset(mutate(
  sub.data,
  gene_name = fData(sce.ifm.4h)[as.character(sub.data$Gene),"gene_name"]),
  gene_name %in% c(
...
ggplot(sub.data) +
  ...
  labs(title = "4h STM-D23580", subtitle = "Violet + / Exposed")
ggsave("08_out/4h_volcano_D23580_Vogel.pdf", height = 5, width = 6.5)
```

```{r fig2_volcano_4h_D23_InfExp, echo=FALSE, eval=FALSE}
ggplot(sub.data) +
  geom_point(
  ...
  scale_x_continuous(limits = mleRange) + theme_bw() +
  labs(title = "4h STM-D23580", subtitle = "Violet + / Exposed")
ggsave("08_out/4h_volcano_D23580_Shalek.pdf", height = 5, width = 6.5)
```

```{r fig1_volcano_4h_LT2_InfExp, echo=FALSE, eval=FALSE}
sub.data <- subset(
  v.data,
  Contrast == "STM-LT2 Violet +-STM-LT2 Exposed" & Time == "4h"
)
geneData <- subset(mutate(
  sub.data,
  gene_name = fData(sce.ifm.4h)[as.character(sub.data$Gene),"gene_name"]),
...
ggplot(sub.data) +
  ...
  scale_x_continuous(limits = mleRange) + theme_bw() +
  labs(title = "4h STM-LT2", subtitle = "Violet + / Exposed")
ggsave("08_out/4h_volcano_LT2_Vogel.pdf", height = 5, width = 6.5)
```

```{r fig2_volcano_4h_LT2_InfExp, echo=FALSE, eval=FALSE}
ggplot(sub.data) +
  geom_point(
    aes(mle, -log10(p.value), colour = p.value < 0.01),
    size = 0.5, alpha = 0.25
  ...
  scale_x_continuous(limits = mleRange) + theme_bw() +
  labs(title = "4h STM-LT2", subtitle = "Violet + / Exposed")
ggsave("08_out/4h_volcano_LT2_Shalek.pdf", height = 5, width = 6.5)
```
  ...
  addGENENAME(tail(
    subset(
      orderResults(convert.z.score(
        scde.res[["6h_STM-D23580_Violet +-6h_STM-LT2_Violet +"]]
        )),
      p.value < 0.01
    ),
  1
...
single.scde.6h(rownames(ex.scde.last.sig), "STM-D23580_Violet +", "STM-LT2_Violet +")
```
...
single.scde.6h("ENSG00000137462", "STM-D23580_Violet +", "STM-D23580_Exposed")
```

### *scde* LT2

```{r single.scde.6h_LT2_TLR2}
single.scde.6h("ENSG00000137462", "STM-LT2_Violet +", "STM-LT2_Exposed")
```
...
single.scde.6h("ENSG00000136634", "STM-D23580_Violet +", "STM-D23580_Exposed")
```

### *scde* LT2

```{r single.scde.6h_LT2_IL10}
single.scde.6h("ENSG00000136634", "STM-LT2_Violet +", "STM-LT2_Exposed")
```
...
single.scde.2h("ENSG00000129472", "STM-D23580_Violet +", "STM-LT2_Violet +")
```
...
single.scde.6h("ENSG00000117280", "STM-D23580_Violet +", "STM-LT2_Violet +")
```
...
c("2h_STM-D23580_Violet +-2h_Mock_Uninfected","2h_STM-LT2_Violet +-2h_Mock_Uninfected"),
c("2h_STM-D23580_Violet +-2h_Mock_Uninfected","2h_STM-D23580_Exposed-2h_Mock_Uninfected"),
c("2h_STM-LT2_Violet +-2h_Mock_Uninfected","2h_STM-LT2_Exposed-2h_Mock_Uninfected"),
c("2h_STM-D23580_Exposed-2h_Mock_Uninfected","2h_STM-LT2_Exposed-2h_Mock_Uninfected")
)
contrasts.contrasts.4h <- list(
c("4h_STM-D23580_Violet +-4h_Mock_Uninfected","4h_STM-LT2_Violet +-4h_Mock_Uninfected"),
c("4h_STM-D23580_Violet +-4h_Mock_Uninfected","4h_STM-D23580_Exposed-4h_Mock_Uninfected"),
c("4h_STM-LT2_Violet +-4h_Mock_Uninfected","4h_STM-LT2_Exposed-4h_Mock_Uninfected"),
c("4h_STM-D23580_Exposed-4h_Mock_Uninfected","4h_STM-LT2_Exposed-4h_Mock_Uninfected")
)
contrasts.contrasts.6h <- list(
c("6h_STM-D23580_Violet +-6h_Mock_Uninfected","6h_STM-LT2_Violet +-6h_Mock_Uninfected"),
c("6h_STM-D23580_Violet +-6h_Mock_Uninfected","6h_STM-D23580_Exposed-6h_Mock_Uninfected"),
c("6h_STM-LT2_Violet +-6h_Mock_Uninfected","6h_STM-LT2_Exposed-6h_Mock_Uninfected"),
...
for (contrastName in unique(v.data$Contrast)){
  ...
  c.x <- gsub(" ", "_", unique(v.subset$Contrast.x))
  message(c.y); message(c.x)
  csvFile <- sprintf("SCDE_v8/compare.4h_%s-4h_%s.csv", c.y, c.x)
  message(csvFile)
  write.csv(v.subset, csvFile)
}
```
...
for (contrastName in unique(v.data$Contrast)){
  ...
  c.x <- gsub(" ", "_", unique(v.subset$Contrast.x))
  message(c.y); message(c.x)
  csvFile <- sprintf("SCDE_v8/compare.6h_%s-6h_%s.csv", c.y, c.x)
  message(csvFile)
  write.csv(v.subset, csvFile)
}
```
