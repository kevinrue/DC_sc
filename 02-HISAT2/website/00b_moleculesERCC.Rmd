...
\begin{equation*} \mu_{i} = C_i \times 10^{-18} \times (6.022 \times 10^{23}) \times (9 \times 10^{-3}) \times D \hspace{0.5cm} \mbox{where,} \end{equation*}
...
* $10$ is the volume added into each well, in $\mu{L}$
