...
As an input, [BASiCS](https://github.com/catavallejos/BASiCS)
requires the input number of spike-in molecules per cell,
...
We may then display the expected count of each ERCC Spike-In injected in
each sample:

```{r ERCCplotCount, message=FALSE, warning=FALSE}
