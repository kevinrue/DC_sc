...
For each experimental grou p of single cells, let us calculate the average
expression level ($log_2(counts+1)$) of each feature.

Let us first initialise a `data.frame`,
and calculate the log~2~-transformed count per million (CPM) after
