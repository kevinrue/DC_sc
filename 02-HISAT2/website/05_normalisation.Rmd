...
that despite the expected differences between experimental groups and batches,
the data set is sufficiently homogenous for the normalisation procedure
to be applied to all cells equally:
