...
```{r 2h_D23580_exposed}
DT::datatable(
  DE.res.batch[["2h_D23580_exposed-2h_Mock_uninfected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
DT::datatable(
  DE.res.batch[["2h_D23580_infected-2h_Mock_uninfected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
```{r 2h_LT2_exposed}
DT::datatable(
  DE.res.batch[["2h_LT2_exposed-2h_Mock_uninfected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
```{r 2h_LT2_infected}
DT::datatable(
  DE.res.batch[["2h_LT2_infected-2h_Mock_uninfected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
```{r 4h_D23580_exposed}
DT::datatable(
  DE.res.batch[["4h_D23580_exposed-4h_Mock_uninfected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
DT::datatable(
  DE.res.batch[["4h_D23580_infected-4h_Mock_uninfected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
```{r 4h_LT2_exposed}
DT::datatable(
  DE.res.batch[["4h_LT2_exposed-4h_Mock_uninfected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
```{r 4h_LT2_infected}
DT::datatable(
  DE.res.batch[["4h_LT2_infected-4h_Mock_uninfected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
```{r 6h_D23580_exposed}
DT::datatable(
  DE.res.batch[["6h_D23580_exposed-6h_Mock_uninfected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
DT::datatable(
  DE.res.batch[["6h_D23580_infected-6h_Mock_uninfected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
```{r 6h_LT2_exposed}
DT::datatable(
  DE.res.batch[["6h_LT2_exposed-6h_Mock_uninfected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
```{r 6h_LT2_infected}
DT::datatable(
  DE.res.batch[["6h_LT2_infected-6h_Mock_uninfected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```

# Display expression profile for differentially expressed genes
