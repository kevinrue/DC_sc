...
DT::datatable(data.frame(
  "Raw" = sapply(names(DE.res.raw), function(n){sum(DE.res.raw[[n]]$cZ != 0)}),
  "Batch" = sapply(names(DE.res.batch), function(n){sum(DE.res.batch[[n]]$cZ != 0)})
  ),
...
for (res.name in names(DE.res.batch)){
  de.batch <- DE.res.batch[[res.name]]
  DE.batch.limit[[res.name]] <- de.batch[1:min(1E3,sum(de.batch$cZ != 0)),]
}
```
...
```{r 2h_D23580_exposed}
DT::datatable(
  DE.batch.limit[["2h_D23580_exposed-2h_Mock_uninfected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
DT::datatable(
  DE.batch.limit[["2h_D23580_infected-2h_Mock_uninfected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
```{r 2h_LT2_exposed}
DT::datatable(
  DE.batch.limit[["2h_LT2_exposed-2h_Mock_uninfected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
```{r 2h_LT2_infected}
DT::datatable(
  DE.batch.limit[["2h_LT2_infected-2h_Mock_uninfected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
```{r 4h_D23580_exposed}
DT::datatable(
  DE.batch.limit[["4h_D23580_exposed-4h_Mock_uninfected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
DT::datatable(
  DE.batch.limit[["4h_D23580_infected-4h_Mock_uninfected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
```{r 4h_LT2_exposed}
DT::datatable(
  DE.batch.limit[["4h_LT2_exposed-4h_Mock_uninfected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
```{r 4h_LT2_infected}
DT::datatable(
  DE.batch.limit[["4h_LT2_infected-4h_Mock_uninfected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
```{r 6h_D23580_exposed}
DT::datatable(
  DE.batch.limit[["6h_D23580_exposed-6h_Mock_uninfected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
DT::datatable(
  DE.batch.limit[["6h_D23580_infected-6h_Mock_uninfected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
```{r 6h_LT2_exposed}
DT::datatable(
  DE.batch.limit[["6h_LT2_exposed-6h_Mock_uninfected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
```{r 6h_LT2_infected}
DT::datatable(
  DE.batch.limit[["6h_LT2_infected-6h_Mock_uninfected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
```{r}
geneId <- rownames(DE.res.batch[["4h_LT2_infected-4h_Mock_uninfected"]])[1]
...
for (groupName in names(DE.res.raw)){
  write.csv(DE.res.raw[[groupName]], sprintf("SCDE/raw_%s.csv",groupName))
...
DT::datatable(data.frame(
  ...
  "Batch" = sapply(contrastsStimulated, function(n){sum(DE.res.batch[[n]]$cZ != 0)})
  ),
  options = list(pageLength = 12)
)
```
...
for (res.name in names(DE.res.batch)){
  de.batch <- DE.res.batch[[res.name]]
  DE.batch.limit[[res.name]] <- head(de.batch, min(1E3,sum(de.batch$cZ != 0)))
}
```
...
DT::datatable(
  DE.batch.limit[["2h_D23580_infected-2h_LT2_infected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
DT::datatable(
  DE.batch.limit[["2h_D23580_infected-2h_D23580_exposed"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
DT::datatable(
  DE.batch.limit[["2h_LT2_infected-2h_LT2_exposed"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
DT::datatable(
  DE.batch.limit[["2h_D23580_exposed-2h_LT2_exposed"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
DT::datatable(
  DE.batch.limit[["4h_D23580_infected-4h_LT2_infected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
DT::datatable(
  DE.batch.limit[["4h_D23580_infected-4h_D23580_exposed"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
DT::datatable(
  DE.batch.limit[["4h_LT2_infected-4h_LT2_exposed"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
DT::datatable(
  DE.batch.limit[["4h_D23580_exposed-4h_LT2_exposed"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
DT::datatable(
  DE.batch.limit[["6h_D23580_infected-6h_LT2_infected"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
```{r 6h_D23580_inf}
DT::datatable(
  DE.batch.limit[["6h_D23580_infected-6h_D23580_exposed"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
```{r 6h_LT2_exp}
DT::datatable(
  DE.batch.limit[["6h_LT2_infected-6h_LT2_exposed"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
DT::datatable(
  DE.batch.limit[["6h_D23580_exposed-6h_LT2_exposed"]],
  options = list(pageLength = 10, searching = TRUE), filter = "top"
)
```
...
sampleAes <- pData(sce.norm)[,c("Time","Infection","Status")]
ggData <- cbind(norm_exprs = geneExpr, sampleAes)
ggplot(ggData, aes(Status, norm_exprs)) +
  geom_violin(draw_quantiles = c(0.25,0.5,0.75)) + geom_jitter(width = 0.2) +
