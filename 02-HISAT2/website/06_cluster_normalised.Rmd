...
ht.2h <- Heatmap(
  mat.e.2h, colorMap, name = "2h", column_title = "2h",
...
ht.4h <- Heatmap(
  mat.e.4h, colorMap, name = "4h", column_title = "4h",
  top_annotation = ht_column,
...
ht.6h <- Heatmap(
  mat.e.6h, colorMap, name = "6h", column_title = "6h",
  top_annotation = ht_column,
...
pdf("06_out/heatmap_pairwise_6h.pdf", height = 5, width = 5)
draw(ht.6h, show_heatmap_legend = FALSE)
dev.off()
```

```{r heatmap.6h_pdf, include=FALSE}
pdf("06_out/heatmap_pairwise_6h_legend.pdf", height = 4, width = 6)
draw(ht.6h)
dev.off()
```
