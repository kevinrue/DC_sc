...
For each group of cells, the aforementioned sets of highly expressed and
highly variable gene features are listed below:

### 6h_D23580_exposed

```{r 6h_D23580_exposed}
DT::datatable(subset(HVGs.group[["6h_D23580_exposed"]], mean > 10 & bio > 5))
```

### 6h_LT2_exposed

```{r 6h_LT2_exposed}
DT::datatable(subset(HVGs.group[["6h_LT2_exposed"]], mean > 10 & bio > 5))
```

### 6h_D23580_infected

```{r 6h_D23580_infected}
DT::datatable(subset(HVGs.group[["6h_D23580_infected"]], mean > 10 & bio > 5))
```

### 6h_LT2_infected

```{r 6h_LT2_infected}
DT::datatable(subset(HVGs.group[["6h_LT2_infected"]], mean > 10 & bio > 5))
```
