...
* ERCC spike-in features show variability levels similar to endogenous
  features.

### Using ERCC spike-in features

Recall that the same set of ERCC spike-in features was added
