...
HeHv_D23_exp <- subset(HVGs.group[["6h_D23580_exposed"]], mean > 10 & bio > 5)
```
...
write.csv(HeHv_D23_exp, "HVGs/6h_D23580_exposed_HeHv.csv")
```

### 6h LT2 exposed

```{r 6h_LT2_exposed_HeHv}
HeHv_LT2_exp <- subset(HVGs.group[["6h_LT2_exposed"]], mean > 10 & bio > 5)
```
...
write.csv(HeHv_LT2_exp, "HVGs/6h_LT2_exposed_HeHv.csv")
```

### 6h D23580 infected

```{r 6h_D23580_infected_HeHv}
HeHv_D23_inf <- subset(HVGs.group[["6h_D23580_infected"]], mean > 10 & bio > 5)
```
...
write.csv(HeHv_LT2_exp, "HVGs/6h_D23580_infected_HeHv.csv")
```
...
write.csv(HVG_LT2_inf, "HVGs/6h_LT2_infected_HeHv.csv")
```
