...
```{r}
pdf(file.path(dirOut, "heatmap_split_time.pdf"), height = 6, width = 12)
...
```{r}
pdf(file.path(dirOut, "heatmap_split_time_k.pdf"), height = 6, width = 15)
...
```{r}
pdf(file.path(dirOut, "heatmap_split_time_anno2.pdf"), height = 10, width = 17)
