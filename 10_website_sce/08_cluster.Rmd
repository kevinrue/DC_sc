...
tmpGG
ggsave(file.path(outdir, "cluster_count_2h_facet.pdf"), width = 9, height = 4)
ggsave(
...
tmpGG
ggsave(file.path(outdir, "cluster_count_4h_facet.pdf"), width = 9, height = 4)
ggsave(
...
tmpGG
ggsave(file.path(outdir, "cluster_count_6h_facet.pdf"), width = 9, height = 4)
ggsave(
