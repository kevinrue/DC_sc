...
outdir <- "06_SCDE_out"; dir.create(outdir, showWarnings = FALSE)
o.ifm.2h <- readRDS("rds/o.ifm_2h.rds")
o.ifm.4h <- readRDS("rds/o.ifm_4h.rds")
o.ifm.6h <- readRDS("rds/o.ifm_6h.rds")
scde.res <- readRDS("rds/scde_res.rds")
goseq.res <- readRDS("rds/goseq_res.rds")
```
...
ggsave("06_SCDE_out/4h_volcano_D23580_Vogel.pdf", height = 5, width = 6.5)
```
...
ggsave("06_SCDE_out/4h_volcano_D23580_Shalek.pdf", height = 5, width = 6.5)
```
...
ggsave("06_SCDE_out/4h_volcano_LT2_Vogel.pdf", height = 5, width = 6.5)
```
...
ggsave("06_SCDE_out/4h_volcano_LT2_Shalek.pdf", height = 5, width = 6.5)
```
...
ggsave("06_SCDE_out/DE_counts.pdf", width = 7, height = 4)
```
