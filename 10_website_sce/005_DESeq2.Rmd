...
safeLevels <- function(x){
  gsub("STM-", "", gsub("Violet +", "Violet", x, fixed = TRUE))
}
```
...
names(deseq.res)
View(addGeneName(deseq.res[["6h_STM-D23580_Violet +-6h_Mock_Uninfected"]]))
View(addGeneName(deseq.res[["6h_STM-D23580_Violet +-6h_STM-LT2_Violet +"]]))
View(addGeneName(deseq.res[["6h_STM-STM-LT2_Violet +-6h_Mock_Uninfected"]]))
View(addGeneName(deseq.res[["4h_STM-D23580_Violet +-4h_STM-D23580_Exposed"]]))
View(addGeneName(deseq.res[["4h_STM-D23580_Violet +-4h_Mock_Uninfected"]]))
```
