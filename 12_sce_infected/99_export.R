sce <- readRDS("12_sce_infected/rds/sce.sc.SCE.rds")
...
sce
write.table(x = colnames(sce), file = "12_sce_infected/export/good_cells.txt", quote = FALSE, col.names = FALSE, row.names = FALSE)
