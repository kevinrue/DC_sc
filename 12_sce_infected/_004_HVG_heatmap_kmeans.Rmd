...
ht_2h <- Heatmap(
  ...
  show_row_names = FALSE, show_column_names = FALSE, width = unit(5, "inches")
)
ht_4h <- Heatmap(
  ...
  show_heatmap_legend = FALSE, width = unit(6, "inches")
)
ht_6h <- Heatmap(
...
anno.subset <- subset(anno.data, Heatmap2 == "x", select=c("gene_name","gene_id"))
...
pdf(file.path(dirOut, "heatmap_panel_time_k_split_annoLink.pdf"), height = 10, width = 21)
draw(
...
pdf(file.path(dirOut, "heatmap_panel_time_k_annoLink.pdf"), height = 10, width = 21)
draw(
