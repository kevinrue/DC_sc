...
outdir <- "09_markers_20180707_out"; dir.create(outdir, showWarnings = FALSE)
...
pdf(
  file.path(outdir, "2h_markers_P_heatmap_logcounts_10x13.pdf"),
  width = 10, height = 13)
draw(ht_final)
dev.off()
```
...
pdf(
  file.path(outdir, "4h_markers_P_heatmap_logcounts_10x13.pdf"),
  width = 10, height = 13)
draw(ht_final)
dev.off()
```
...
pdf(
  file.path(outdir, "6h_markers_P_heatmap_logcounts_10x13.pdf"),
  width = 10, height = 13)
draw(ht_final)
dev.off()
```
