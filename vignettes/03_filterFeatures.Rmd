...
\fixme{
Below is a matrix of PCA plots using combinations of the first four principal
components. The figure should be updated to present a matrix 3x3 showing
plots related to PC1 in the first row and column, and so on.
}
