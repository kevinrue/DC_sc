...
```
wget http://ftp.ensembl.org/pub/release-86/fasta/homo_sapiens/dna/Homo_sapiens.GRCh38.dna.toplevel.fa.gz
gunzip Homo_sapiens.GRCh38.dna.toplevel.fa.gz
cat Homo_sapiens.GRCh38.dna.toplevel.fa ERCC92.fa > genome_with_ERCC92.fa
```
...
cat Homo_sapiens.GRCh38.86.gtf ERCC92.gtf > genes_with_ERCC.gtf
```
